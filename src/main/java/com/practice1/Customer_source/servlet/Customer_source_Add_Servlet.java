...
/**
 * Servlet implementation class Customer_source_Add_Servlet
 */
public class Customer_source_Add_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Customer_source_Add_Servlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Customer_source care=new Customer_source();
