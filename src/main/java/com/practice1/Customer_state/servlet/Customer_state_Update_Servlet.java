...
/**
 * Servlet implementation class Customer_state_Update_Servlet
 */
public class Customer_state_Update_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Customer_state_Update_Servlet() {
        super();
