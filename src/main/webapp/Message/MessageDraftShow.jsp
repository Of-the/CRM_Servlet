...
<body>
	...
	<form action="MessageDraftShowServlet">
	...
	<tr>
		<td>${i.message_id}</td>
		<td>${i.username}</td>
		<td><a href="MessageShowOneServlet?message_id=${i.message_id}&b=3">${i.subject}</a></td>
		<td>${i.send_time}</td>
		<td><a href="MessageDraftDeleteServlet?message_id=${i.message_id}">X</a>
		<a href="MessageOutboxUpdateServlet?message_id=${i.message_id}">✎</a></td>
	</tr>	
	</c:forEach>
	</table>
</body>
