...
<body>
	<h2>发件箱</h2>
	<form action="MessageOutboxServlet">
	...
	<tr>
		<td>${i.message_id}</td>
		<td>${i.username}</td>
		<td><a href="MessageShowOneServlet?message_id=${i.message_id}&b=2">${i.subject}</a></td>
		<td>${i.send_time}</td>
		<td><a href="MessageOutboxDeleteServlet?message_id=${i.message_id}">X</a>
		</td>
	</tr>	
	</c:forEach>
	</table>
